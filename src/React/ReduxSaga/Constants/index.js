...
export const RESPONSE_UPDATE_STATUS_EVENT = 'RESPONSE_UPDATE_STATUS_EVENT'
export const REQUEST_UPDATE_STATUS_EVENT = 'REQUEST_UPDATE_STATUS_EVENT'

//REDUCER
export const CLEAN_REDUCER = 'CLEAN_REDUCER';
export const CLEAR_ADD_OR_UPDATE_EVENT = 'CLEAR_ADD_OR_UPDATE_EVENT';